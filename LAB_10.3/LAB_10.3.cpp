...
void savePhoneBookToFile(const map<string, Employee>& phoneBook, const string& filename) {
...
void readPhoneBookFromFile(map<string, Employee>& phoneBook, const string& filename) {
...
int main() {
    ...
    readPhoneBookFromFile(phoneBook, filename); while (true) {
        cout << "Menu:" << endl;
